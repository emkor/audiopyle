...
class AudioSegmentReaderIntegrationTest(unittest.TestCase):
    def setUp(self):
        ...
        self.audio_meta = AudioMeta(XtracterConst.TEST_WAV_FILE_NAME, XtracterConst.TEST_WAV_FILE_CHANNELS_COUNT,
    ...
    def test_should_read_test_wav_file_into_segments(self):
        ...
        assert_that(len(segments)).is_equal_to(
                math.ceil(XtracterConst.TEST_WAV_FILE_FRAME_COUNT / float(XtracterConst.DEFAULT_BLOCK_SIZE)))
