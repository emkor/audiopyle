...
def extract_feature(extraction_request: Dict[Text, Any]) -> Dict[Text, Any]:
    ...
    meta_file_store = JsonFileStore(RESULTS_DIR)
    ...
    try:
        ...
        meta_file_store.store("{}-data".format(task_id), feature.to_serializable())
        ...
        meta_file_store.store("{}-meta".format(task_id), analysis_result.to_serializable())
        ...
        meta_file_store.store("{}-stats".format(task_id), analysis_stats.to_serializable())
