...
from audiopyle.commons.utils.conversion import utc_timestamp_to_datetime
from audiopyle.commons.utils.file_system import file_exists, concatenate_paths, remove_file, get_file_name, list_full_paths, \
...
class FileStore(object):
    ...
    def get_full_path(self, file_name: Text) -> Text:
