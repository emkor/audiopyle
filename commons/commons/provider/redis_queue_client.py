...
class RedisQueueClient(object):
    ...
    def add(self, element):
        try:
            ...
            logging.error("Could not add element: {} to Redis queue {} Details: {}".format(element, self.queue_name, e))
    ...
    def take(self):
        try:
            ...
            logging.error("Could not read from Redis queue {} Details: {}".format(self.queue_name, e))
            return None
    ...
    def length(self):
        try:
            ...
            logging.error("Could not check length of Redis queue {} Details: {}".format(self.queue_name, e))
            return 0
    ...
    def list(self):
        try:
            ...
            logging.error("Could not list Redis {} queue elements. Details: {}".format(self.queue_name, e))
            return []
    ...
    def clear(self):
        try:
            ...
            logging.error("Could not clear Redis {} queue. Details: {}".format(self.queue_name, e))
