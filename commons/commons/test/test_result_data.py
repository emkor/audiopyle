...
from commons.models.result import FeatureMeta, ResultVersion, FeatureType, AnalysisResult
from commons.utils.serialization import to_json


class AnalysisResultDataModelTest(unittest.TestCase):
    def setUp(self):
        self.result_data_example = FeatureMeta(ResultVersion.V1, "fa3b5d8c-b760-49e0-b8b5-7ce0737621d8",
