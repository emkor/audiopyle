...
class Mp3AudioFileMetaTest(unittest.TestCase):
    def setUp(self):
        self.mp3_audio_file_meta = CompressedAudioFileMeta(file_name="file.mp3", channels_count=1,
    ...
    def test_should_serialize_and_deserialize_audio_meta_file(self):
        ...
        new_audio_file_meta = CompressedAudioFileMeta.from_serializable(audio_file_meta_serialized)
