...
from commons.models.file_meta import WavAudioFileMeta, Mp3AudioFileMeta


class WavAudioFileMetaTest(unittest.TestCase):
    def setUp(self):
        self.wav_audio_file_meta = WavAudioFileMeta(channels_count=2, sample_rate=44100, frames_count=22050,
                                                    bit_depth=16)
    ...
    def test_should_serialize_and_deserialize_audio_meta_file(self):
        audio_file_meta_serialized = self.wav_audio_file_meta.to_serializable()
        new_audio_file_meta = WavAudioFileMeta.from_serializable(audio_file_meta_serialized)
...
class Mp3AudioFileMetaTest(unittest.TestCase):
    def setUp(self):
        self.mp3_audio_file_meta = Mp3AudioFileMeta(channels_count=1, sample_rate=44100, length_sec=0.5, bit_rate_kbps=128.)
