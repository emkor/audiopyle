...
class B2AudioProviderIntegrationTest(unittest.TestCase):
    def setUp(self):
        self.b2_test_config = B2Config(AudiopyleConst.B2_ACCOUNT_ID, AudiopyleConst.B2_APPLICATION_KEY,
    ...
    def test_file_should_exists(self):
        test_file_exists = self.audio_provider.remote_file_path_exists(self.b2_test_config,
                                                                       AudiopyleConst.B2_TEST_FILE_PATH)
    ...
    def test_get_files_raw_info_should_contain_test_file_meta(self):
        expected_remote_file = RemoteFileMeta(AudiopyleConst.B2_TEST_FILE_PATH, AudiopyleConst.B2_TEST_FILE_SIZE,
                                              AudiopyleConst.B2_TEST_FILE_UPLOAD_TIMESTAMP)
    ...
    def test_should_download_remote_file(self):
        local_file_path = self.audio_provider.download(self.b2_test_config, AudiopyleConst.B2_TEST_FILE_PATH)
