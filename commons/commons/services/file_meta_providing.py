...
from commons.utils.file_system import file_exists, get_file_name
...
def read_wav_file_meta(absolute_path: Text) -> Optional[WavAudioFileMeta]:
    if file_exists(absolute_path):
        ...
        try:
            ...
            audio_file.close()
            return WavAudioFileMeta(absolute_path=absolute_path, channels_count=nchannels,
...
def read_mp3_file_meta(absolute_path: Text) -> Optional[Mp3AudioFileMeta]:
    if file_exists(absolute_path):
        ...
        try:
            ...
            return Mp3AudioFileMeta(absolute_path=absolute_path, channels_count=mp3.info.channels,
                                    sample_rate=mp3.info.sample_rate, bit_rate_kbps=to_kilo(mp3.info.bitrate),
