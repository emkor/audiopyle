...
def read_wav_file_meta(absolute_path: Text) -> Optional[WavAudioFileMeta]:
    if file_exists(absolute_path):
        ...
        try:
            ...
            audio_file.close()
            return WavAudioFileMeta(channels_count=nchannels, bit_depth=B_to_b(sampwidth), sample_rate=framerate, frames_count=nframes)
...
def read_mp3_file_meta(absolute_path: Text) -> Optional[Mp3AudioFileMeta]:
    if file_exists(absolute_path):
        ...
        try:
            ...
            return Mp3AudioFileMeta(channels_count=mp3.info.channels, sample_rate=mp3.info.sample_rate,
